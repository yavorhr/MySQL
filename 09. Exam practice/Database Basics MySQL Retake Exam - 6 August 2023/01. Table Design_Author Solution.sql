DROP SCHEMA database_retake2023;
CREATE SCHEMA database_retake2023;
USE database_retake2023;
...
#
# # # 04.	Data Deletion
# DELETE p FROM property_transactions p
...
##7
# SELECT SUBSTRING(p.address,1,6) agent_name, CHAR_LENGTH(p.address)*5430 price FROM properties p
# LEFT JOIN property_offers po on p.id = po.property_id
# WHERE po.agent_id IS NULL
# ORDER BY agent_name desc,price desc;

##8
# SELECT bank_name,COUNT(*) count FROM property_transactions pt
# GROUP BY bank_name
# HAVING count>=9
